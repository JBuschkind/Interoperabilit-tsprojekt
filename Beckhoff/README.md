...
So kannst du das Tool direkt per CLI ausfuehren.
Die folgenden Beispiele zeigen jeweils einen Aufruf pro Richtung.

### Beispiel CLI-Aufruf: Forward

```powershell
dotnet run --project .\xmlParser.csproj -- --direction forward
```

### Beispiel CLI-Aufruf: Reverse
