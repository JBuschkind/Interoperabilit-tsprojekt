...
export default function Layout() {
    return (
        <div className="h-screen flex flex-col bg-surface text-surface font-body ">
            {/* Header */}
            <header className=" px-6 shrink-0 bg-slate-950/80 backdrop-blur-xl shadow-2xl shadow-black/50">
            ...
            <main className="flex-1 flex flex-col items-center overflow-y-auto pt-16 pb-8 scrollbar-custom">
